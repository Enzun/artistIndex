...
const ACHIEVEMENT_DEFS: AchievementDef[] = [
  ...
  // 早期発見系
  { category: '早期発見', name: '超監視者 [アーティスト]', condition: '公開から1日以内に購入', type: '付与型', status: '実装済み', perArtist: true },
  { category: '早期発見', name: '監視者 [アーティスト]', condition: '公開から3日以内に購入', type: '付与型', status: '実装済み', perArtist: true },
  { category: '早期発見', name: '発掘者 [アーティスト]', condition: '公開から7日以内に購入', type: '付与型', status: '実装済み', perArtist: true },
  { category: '早期発見', name: '先行者 [アーティスト]', condition: '公開から30日以内に購入', type: '付与型', status: '実装済み', perArtist: true },
  // 長期保有系
  { category: '長期保有', name: '1ヶ月ホルダー [アーティスト]', condition: '初回購入から30日以上保有', type: '付与型', status: '実装済み', perArtist: true },
  { category: '長期保有', name: '3ヶ月ホルダー [アーティスト]', condition: '初回購入から90日以上保有', type: '付与型', status: '実装済み', perArtist: true },
  { category: '長期保有', name: '半年ホルダー [アーティスト]', condition: '初回購入から180日以上保有', type: '付与型', status: '実装済み', perArtist: true },
  { category: '長期保有', name: '年間ホルダー [アーティスト]', condition: '初回購入から365日以上保有', type: '付与型', status: '実装済み', perArtist: true },
  // 規模系
